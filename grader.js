...
+ JSON
 ...
 - https://developer.mozilla.org/en-US/docs/JSON#JSON_firefox_2
*/
...
var clone = function(fn){
    ...
    // hhtp://stackoverflow.com/a/6772648
    return fn.bind({});
};
...
if(require.main==module){
    program
        ...
        .option('-u, --url <url>', 'URL to a web page',clone(assertURLExists),URL_DEFAULT) 
        .parse(process.argv);
